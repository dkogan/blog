...
set title "Number of roads in each lat/lon cell"

unset colorbox

set terminal png enhanced size 800,510
set output "big_samplegrid_all.png"


plot \
     "montage_40_-96_1600miles_4.png" binary filetype=png flipy using 1:2:3 with rgbimage notitle axis x1y1, \
     "samples.dat" using 2:1:(sqrt(sqrt($3))/10):3 with points pt 7 ps variable palette axis x2y2 notitle
